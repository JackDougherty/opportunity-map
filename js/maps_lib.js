...
var MapsLib = {
  ...
  polygonRaceDot: "http://magic.lib.uconn.edu/test/n/kml/DotDens250.kmz",
  ...
  initialize: function() {
    ...
    MapsLib.polygonRaceDot = new google.maps.KmlLayer({
      url: polygonRaceDot
    });
...
if ($("#cbRaceDot").is(':checked')) {
  MapsLib.polygonRaceDot.setMap(map);
}
//-----end custom filters
  ...
  clearSearch: function() {
    ...
    if (MapsLib.polygonRaceDot != null) // Testing this approach
